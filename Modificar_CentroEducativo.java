...
public class Modificar_CentroEducativo extends javax.swing.JFrame {
    ...
    public Modificar_CentroEducativo(Lista_Doble centrosEducativos, int indiceSeleccionadoCentroEdu) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().isEmpty()) {
            ...
            aux1.setNombre(nombre.toUpperCase());

            if (centrosEducativos.VerificaNombreRepetido(nombre) == true) {
                JOptionPane.showMessageDialog(null, "Este Centro Educativo ya esta registrado");

            } else {
                jTextField1.setBorder(new LineBorder(Color.WHITE));

                JOptionPane.showMessageDialog(null, "Se ha modificado el Centro Educativo CORRECTAMENTE.");
...
// Verificar si la tecla presionada es la tecla de retroceso
        if (evt.getKeyChar() == KeyEvent.VK_BACK_SPACE) {
            return; // No hacer ninguna validación si es la tecla de retroceso
        }

        try {
            // Verificar si el carácter no es un dígito
            if (!Character.isLetter(evt.getKeyChar())) {
                // Si no es un dígito, lanzar una excepción
            ...
            // Consumir el evento para que el carácter no sea añadido al JTextField
            evt.consume();
        }
