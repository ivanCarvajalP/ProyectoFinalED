...
public class Modificar_Curso extends javax.swing.JFrame {
    ...
    public Modificar_Curso(Lista_Doble centrosEducativos, int indiceSeleccionadoCentroEdu, int indiceSeleccionadoCurso) {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/curso.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().isEmpty()) {
            ...
            aux2.setNombre(nombre.toUpperCase());
