...
public class Registrar_Curso extends javax.swing.JFrame {
    ...
    public Registrar_Curso(Lista_Doble centrosEducativos, int indiceSeleccionadoCentroEdu) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().isEmpty()) {
            ...
            if (aux1.getCursos().VerificaNombreRepetido(nombre) == true) {
                JOptionPane.showMessageDialog(null, "Este Curso ya esta registrado.", "Error", JOptionPane.ERROR_MESSAGE);

            } else {
                aux1.getCursos().Encolar(new Curso(cod, nombre.toUpperCase(), new Pila(), 0));
                jTextField1.setText("");
                ...
                JOptionPane.showMessageDialog(null, "El Curso se ha registrado CORRECTAMENTE.");
